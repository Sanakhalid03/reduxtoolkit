...
function Allproducts() {
  ...
  return (
    <div className="w-[95%] md:w-[90vw] lg:w-[90vw]  bg-white shadow-lg shadow-amber-900 mx-auto mt-5 md:p-10 lg:p-10">
     <h1 className="text-center text-amber-900 text-4xl font-bold ">All Products</h1>
    <div className="w-full md:w-full lg-w-full md:flex md:gap-8 md:justify-center md:flex-wrap lg:flex lg:gap-8 lg:justify-center lg:flex-wrap  mt-5">
